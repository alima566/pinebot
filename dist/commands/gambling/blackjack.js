...
exports.default = {
    ...
    execute({ client, message, args }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let pointsToGamble = utils_1.removeCommas(args[0].trim());
            if (actualPoints == 0) {
...
const playGame = (client, message, pointsToGamble, guildID, userID, text) => __awaiter(void 0, void 0, void 0, function* () {
    deck = createDeck();
    shuffleDeck(deck);
