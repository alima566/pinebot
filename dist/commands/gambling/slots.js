...
exports.default = {
    ...
    execute({ client, message, args }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const actualPoints = yield gambling_1.getPoints(guild.id, author.id);
            ...
            if (pointsToGamble.toLowerCase() == "all") {
                if (isSlotsWin(slot1, slot2, slot3)) {
                    ...
                    yield gambling_1.updateJackpotAmount(client, guild.id, Math.ceil(actualPoints / 2));
                    yield gambling_1.addPoints(guild.id, author.id, actualPoints * -1);
                    return message.reply({
            ...
            if (isSlotsWin(slot1, slot2, slot3)) {
                ...
                yield gambling_1.updateJackpotAmount(client, guild.id, Math.ceil(+pointsToGamble / 2));
                const newPoints = yield gambling_1.addPoints(guild.id, author.id, +pointsToGamble * -1);
                return message.reply({
...
const slotsWin = (guildID, userID, pointsWon, slotsText, message) => __awaiter(void 0, void 0, void 0, function* () {
